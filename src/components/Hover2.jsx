function Hover2({text}) {
    return (
        <div className=" -bottom-35 -left-5 absolute pointer-events-none text-base  px-4 py-2 rounded-lg bg-purple-900 border border-purple-700  tracking-tighter font-bold">
